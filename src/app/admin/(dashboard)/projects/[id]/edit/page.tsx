  ...
  useEffect(() => {
    async function loadProject() {
      try {
        ...
        if (!project) {
          addToast("Không tìm thấy dự án", "error");
        ...
        reset({
          ...
          category: project.category || "Video nổi bật",
        ...
        setServices(project.services.length > 0 ? project.services : [""]);
      } catch (error) {
    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 max-w-4xl">
        ...
        <div className="flex items-center justify-end gap-3 pt-2">
          ...
          >
            {submitting ? "Đang lưu..." : "Cập nhật dự án"}
          </button>
        </div>
      </form>
    </div>
